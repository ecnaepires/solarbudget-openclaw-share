    ...
    *,
    ...
    if process_clicked:
        ...
        try:
            ...
            st.error(
                f"Falha no processamento [{exc_type}]: {exc}\n\n"
                "Verifique se: os PDFs nao estao protegidos por senha, o adaptador selecionado "
                "corresponde a sua distribuidora, e o arquivo template.xlsx esta presente na pasta."
            )
